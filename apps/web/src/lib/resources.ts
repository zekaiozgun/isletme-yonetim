...
const mainResources: ResourceConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'known_dam_name', label: 'Dış Kaynaklıysa: Bilinen Annesinin Adı', type: 'text' },
      { name: 'note', label: 'Not', type: 'textarea' },
    ],
  },
  {
  ...
  },
  {
    slug: 'feed-purchases',
    title: 'Yem Alımları',
    singularTitle: 'Yem Alımı',
    group: 'Yem',
    listEndpoint: '/feed/purchases',
    createEndpoint: '/feed/purchases',
    columns: [
    ...
    fields: [
      ...
      { name: 'purchase_date', label: 'Tarih', type: 'date', required: true },
      ...
      { name: 'total_cost', label: 'Toplam Maliyet (TL)', type: 'decimal' },
      { name: 'note', label: 'Not', type: 'textarea' },
    ],
    relatedReports: [{ slug: 'feed-stock-status', title: 'Yem Stok Durumu' }],
  },
  {
    slug: 'buyers',
    title: 'Alıcılar',
